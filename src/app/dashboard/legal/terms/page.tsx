      ...
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
          <div className="prose prose-slate">
            ...
            <ul>
              <li>
                Utilizar el sitio para actividades ilegales, fraudulentas o que vulneren derechos de
                terceros.
              </li>
            ...
            <p>
              ...
              daños directos, indirectos o consecuenciales derivados del uso o la imposibilidad de uso del
              sitio.
            </p>
            ...
            <p>
              ...
              <a href="/dashboard/legal/privacy">Política de Privacidad</a> de ReLead Digital. Te
            ...
            <p>
              Cuando nos contactas a través de formularios, correo electrónico o WhatsApp, aceptas recibir
              respuestas relacionadas con tu consulta, propuestas de trabajo o seguimiento de proyectos.
            </p>
            ...
            <p>
              ...
              versión vigente será la que esté publicada en esta página, indicando la fecha de última
              actualización.
            </p>
            ...
            <p className="text-slate-700">
              <em>Este texto tiene fines informativos y generales. No sustituye asesoría legal
              personalizada.</em>
            </p>
          </div>
        </div>
